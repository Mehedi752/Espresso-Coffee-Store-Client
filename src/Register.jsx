    ...
    const handleLogInWithGoogle = () => {
        signInWithGoogle()
            .then(result => {
                ...
                toast.success(`Congrats ${result.user.displayName} Your Login Success With Google in The Espresso Emporium!`, {
                    position: "top-center",
                    autoClose: 2000,
                    pauseOnHover: true,
                    theme: "colored",
        ...
        createNewUser(email, password)
            .then(result => {
                ...
                updateProfileUser({ displayName: name, photoURL: photo })
                    .then(() => {
                        navigate(location?.state ? location.state : '/');
                        toast.success(`Congrats ${result.user.displayName}, Register Success in The Espresso Emporium!`, {
                            position: "top-center",
                            autoClose: 2000,
                            pauseOnHover: true,
                            theme: "colored",

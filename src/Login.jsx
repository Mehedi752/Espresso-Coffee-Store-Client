...
const Login = () => {
    ...
    const handleLogInWithGoogle = () => {
        ...
        signInWithGoogle()
            .then(result => {
                ...
                toast.success(`Congrats ${result.user.displayName}, Your Login Success in The Espresso Emporium!`, {
                    position: "top-center",
                    autoClose: 2000,
                    pauseOnHover: true,
                    theme: "colored",
    ...
    const handleForgotPassword = () => {
        navigate('/forgot-password', { state: emailRef.current.value });
    }
    ...
    return (
        ...
        <div className="bg-[#f3f3f3]">
            <div div className='container mx-auto lg:px-[300px] px-10 lg:py-[100px] py-10' >
